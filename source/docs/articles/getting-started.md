...
If you have an existing Drupal or WordPress site that you want to import, choose **Import manually**. For additional details, see [Migrate Sites to Pantheon](/docs/articles/sites/migrate)
