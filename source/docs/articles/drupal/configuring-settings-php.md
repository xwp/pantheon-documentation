...
For information about table prefixes on Pantheon, see [Importing an Existing Drupal Site to Pantheon](/docs/articles/sites/migrate/importing-an-existing-site/).
